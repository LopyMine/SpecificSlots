...
public class WSwitcher extends WWidget {
    ...
    public void paint(MatrixStack matrices, int x, int y, int mouseX, int mouseY) {
        ...
        ScreenDrawing.texturedRect(matrices, x, y, 14, 22, DrawUtils.getTexture(DARK_TEXTURE, VANILLA_TEXTURE, shouldRenderInDarkMode()), buttonLeft, buttonTop, buttonLeft + buttonWidth, buttonTop + buttonHeight, 0xFFFFFFFF);
    }
